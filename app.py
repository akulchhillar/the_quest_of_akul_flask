...
def hello_world():
    ...
    ht.h1.decompose()
    img = "https://raw.githubusercontent.com/akulchhillar/the_quest_of_akul_flask/main/static/assests/transparent/"+str(randrange(1,35))+".png"
...
def posts():
    img = "https://raw.githubusercontent.com/akulchhillar/the_quest_of_akul_flask/main/static/assests/transparent/"+str(randrange(1,35))+".png"
    return render_template('posts.html',posts=get_all_posts(),img=img)
...
def error(e):
    img = "https://raw.githubusercontent.com/akulchhillar/the_quest_of_akul_flask/main/static/assests/transparent/"+str(randrange(1,35))+".png"
    return render_template('404.html',img=img)
